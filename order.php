        ...
        <form action="" method="POST" class="order">
            ...
            <fieldset>
                ...
                <input type="tel" name="contact" 
                    value="<?php echo isset($_SESSION['customer_contact']) ? $_SESSION['customer_contact'] : ''; ?>" 
                ...
                <input type="email" name="email" 
                    ...
                    placeholder="E.g. farzana@gmail.com" 
                    class="input-responsive" required>

                <div class="order-label">Address</div>
                <textarea name="address" rows="10" 
                    placeholder="E.g. Street, City, Country" 
                    class="input-responsive" required><?php echo isset($_SESSION['customer_address']) ? $_SESSION['customer_address'] : ''; ?></textarea>
